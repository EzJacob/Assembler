...
| -------- | -------- | -------- | -------- | -------- |
| 0 | Immediate addressing | The additional word of the instruction contains the operand itself, which is a number represented in 12 bits, to them a pair of bits is added from the field A, R, E | The operand starts with # and after it and next to it a whole number appears in the base decimal | mov #-1,r2 In this example the first operand of the command given by address method immediate. The instruction is writing the value -1 into r2 register |
